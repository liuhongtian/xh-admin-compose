...
CREATE database if NOT EXISTS `xh_admin_bak` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use `xh_admin`;
...
CREATE TABLE `sys_dict_detail`  (
                                    ...
                                    `enabled` int NULL DEFAULT NULL COMMENT '是否启用1：是，0：否',
                                    `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                                    `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                                    `create_by` int NULL DEFAULT NULL COMMENT '创建人',
                                    `update_by` int NULL DEFAULT NULL COMMENT '修改人',
                                    `deleted` int NULL DEFAULT 0 COMMENT '是否已删除1：是，0：否',
...
CREATE TABLE `sys_log`  (
                            ...
                            `create_by` int NULL DEFAULT NULL COMMENT '创建人',
                            `update_by` int NULL DEFAULT NULL COMMENT '修改人',
                            `deleted` int NOT NULL DEFAULT 0 COMMENT '是否已删除1：是，0：否',
                            PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_menu`  (
                             ...
                             `order` int NULL DEFAULT NULL COMMENT '排序号',
                             `cache` int NULL DEFAULT NULL COMMENT '是否缓存1：是，0：否',
                             `enabled` int NULL DEFAULT NULL COMMENT '是否启用1：是，0：否',
                             `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                             `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                             `create_by` int NULL DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `sys_user`  (
                             ...
                             `enabled` int NULL DEFAULT NULL COMMENT '是否启用1：启用，0：禁用',
                             `allow_repeat` int NULL DEFAULT NULL COMMENT '允许重复登录1：允许，0：不允许',
                             `auto_renewal` int NULL DEFAULT NULL COMMENT '自动续签，请求会自动延长token失效时间1：自动，0：不自动',
                             `is_demo` int NULL DEFAULT NULL COMMENT '是否演示账号1：是，0：否',
                             `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                             `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                             `create_by` int NULL DEFAULT NULL COMMENT '创建人',
                             `update_by` int NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `sys_user_job`  (
                                 `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
                                 `type` int NULL DEFAULT NULL COMMENT '1：用户，2：用户组',
...
(
    ...
    create_by   int                  null comment '创建人',
    update_by   int                  null comment '修改人',
    deleted     int default 0 null comment '是否已删除1：是，0：否'
)
    comment '数据权限';
